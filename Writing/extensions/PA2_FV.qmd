...
The 5-fold cross validation produced results displayed in (@tbl-5cv-dataseta-yolo-folds).
...
The 2-fold cross validation produced results displayed in (@tbl-5cv-dataseta-rfdetr-val).
...
![Validation Comparison](figures/Roboflow/Roboflow_VALID.png){#fig-valid-data-a}  
