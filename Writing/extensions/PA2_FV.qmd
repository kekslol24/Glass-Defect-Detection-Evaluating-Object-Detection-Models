...
The effect of data scarcity on Dataset B (only 208 images) was distinctly visible in the training plots (@fig-fig-yolo-kaggle-train for YOLO and @fig-rfdetr-kaggle-train for RF-DETR). 
...
**Sample Images from the YOLO Model**
